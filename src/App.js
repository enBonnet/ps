...
export const App = () => {
    ...
    login()
      ...
      .then((response) => {
        response.data.isAdmin
          ? setCurrentPage("registerActivitie")
          : setCurrentPage("packageForm");
      })
  ...
  const addCard = (e) => {
    ...
    const region = regionList.find(
      (region) => Number(region.idREGION) === Number(regionId)
    );
    const comuna = comunaList.find(
      (comuna) => Number(comuna.idCOMUNA) === Number(comunaId)
    );
    const lugar = lugarList.find(
      (lugar) => Number(lugar.idLUGAR) === Number(idLugar)
    );
  ...
  if (currentPage === "packageForm")
    return (
      <div className="my-1">
        ...
        <div className="card container mt-3 bg-dark text-white">
          <div className="card-header  mt-2 text-uppercase text-center">
                ...
                <div className="card text-left bg-white border border-dark text-dark my-2">
                  <div className="card-body text-center">
                    ...
                    <div className="d-flex ml-5 mt-3">
                      ...
                      <h5 className="ml-4 mt-2">
                        {activitie.address}, {activitie.city}.{" "}
                        {activitie.region}, Chile
                      </h5>
                    </div>
                    <div className="d-flex ml-5 mt-3">
                      <Icon.Cash size={30} />
                      <h5 className="ml-4 mt-2">${activitie.precio}</h5>
                    </div>
                  </div>
                </div>
              );
    ...
    return (
      <div className="container border border-dark mt-3 bg-dark text-white">
        <h5 className="text-center border-bottom border-white mt-2">
          Detalle de Reserva
        </h5>
        <ul className="list-group list-group-flush">
          {cardActivities.map((activitie) => {
              ...
              <div className="card text-left bg-white border border-dark text-dark my-2">
                <div className="card-body text-center">
                  ...
                  <div className="d-flex ml-5 ">
                    <Icon.GeoAltFill size={30} />
                    <h5 className="ml-4 mt-2">
                      {activitie.address}, {activitie.city}. {activitie.region},
                      Chile
                    </h5>
                  </div>
                </div>
        ...
        <ul className="list-group list-group-flush">
          <div className="card text-left bg-white border border-dark text-dark my-2">
            ...
            <h5 className="ml-2 text-center">
              Precio total: $ {companions * packagePrice}
            </h5>
          </div>
        </ul>
        <div className="text-center mt-3">
